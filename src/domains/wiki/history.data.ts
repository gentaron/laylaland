...
export const WIKI_HISTORY = [
...

  {
    ...
    descriptionEn: "The unprecedented great plague that occurred in E208. A virus that specifically acted on the genes of immigrants from the Andromeda galaxy mutated and wreaked havoc, causing catastrophic damage with approximately 45 million deaths, accounting for about 15% of the population. This plague created deep-seated distrust between immigrant and native populations, and directly led to the formation of the Shadow Rebellion, centered on affected immigrant communities. Later, it was suggested that the plague virus may have been artificially modified.",
  },
...

  {
    ...
    descriptionEn: "A series of unification wars waged by the military faction Phalanx from E12 to E15. As the various residential areas developed independently, conflicts over resource allocation and territorial disputes intensified, leading to frequent small-scale armed conflicts across the region. Phalanx ended these conflicts through force and established a legal order and infrastructure throughout the Symphony of Stars. During the unification wars, Phalanx significantly advanced military technology, establishing a tactical system that became the prototype for later Techrosus lineages. This unification war, which directly led to the establishment of the V Empire in E15, is evaluated by historians as the first example of the cycle of \"unity and divergence\" in the E16 civilization sphere.",
  },
...

  {
    ...
    descriptionEn: "The second wave of immigrant groups that arrived from Earth between E70 and E85. Utilizing the communication infrastructure built by the first colonization fleet, the second wave brought approximately 200,000 immigrants to the Symphony of Stars. The new immigrants included diverse professionals such as agricultural technicians, physicians, and engineers, dramatically enhancing the self-sufficiency of the settlements. However, the rapid population growth created tensions with the original first-wave colonists, becoming one of the underlying causes of the Lombardia War in E88. The diverse cultural backgrounds brought by the second wave of immigrants are said to have formed the foundation of the cultural diversity of the later E16 civilization sphere and influenced the theoretical system of Fermi music.",
  },
  ...
  /* パクス〜繁栄 (E150〜E288) */
  {
    ...
    descriptionEn: "The beginning of the \"Pax Lombardica\" era, which lasted from E205 to E278, when major corporate groups declared a transition to a coordinated governance system. The Lombardia Empire provided the framework for a cooperative system among corporatocracies, achieving long-term stability for about 70 years. During this period, the Lorenzo International University was established on Planet Biblio, and fundamental research into dimensional horizon theory began in earnest. However, as oligopolization among corporations advanced and the political participation rights of citizens became increasingly restricted, these factors ultimately led to the transition to ZAMLT's aggressive economic hegemony. The prosperity of the Pax Lombardica is remembered in the E16 civilization sphere as the \"golden age of corporate governance,\" and its institutional legacy continues to influence the framework of the current UECO.",
  },
...

  {
    ...
    descriptionEn: "A series of historical events from E316 to E318 where Alpha Cain, raised in the Tesla District, won the Still Arena and triggered the miraculous phenomenon of awakening his conjugate pair. Alpha Cain proved his overwhelming combat prowess in the Still Arena, becoming a symbol of hope for citizens in the lower classes under ZAMLT's rule. In E318, he organized the Shadow Rebellion and launched the Gigapolis Liberation War in coordination with the warriors of Techlos. The awakening of his conjugate pair was an unknown phenomenon that overturned the principles of ZAMLT's dimensional energy technology. With this awakening, Cain executed a legendary hacking attack on ZAMLT's OmniBus Engine and forcibly occupied the Megatower of Gigapolis. Cain's awakening and liberation war are etched in history as the symbol of \"the fall of Corporateocracy\" in the E16 civilization sphere.",
  },
