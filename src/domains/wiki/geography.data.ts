...
export const WIKI_GEOGRAPHY = [
  /* 宇宙・天文 */
  {
    ...
    descriptionEn: "Located in the halo region of the M104 Galaxy (Sombrero Galaxy), this binary star system is the mother system of the E16 civilization zone, which harbors habitable planets including Symphony of Stars. The primary star Ea16 is a yellow-white giant of spectral type F5, while its companion Eb16 is a red dwarf of spectral type M3. The orbital resonance between the two stars creates a stable habitable zone. The estimated age of the binary system is approximately 6.2 billion years, and it contains abundant heavy elements, leading to active planet formation. The E16 binary system has been within navigable distance since before the Eastern Calendar, and since the arrival of the initial colonization fleet, it has developed into the most important transportation and trade hub in the galactic halo.",
  },

  {
    ...
    descriptionEn: "The primary star of the E16 binary system, a yellow-white giant of spectral type F5. It has a mass of 1.2 solar masses, a surface temperature of approximately 6,500K, and a luminosity reaching about 3.2 times that of the Sun. It provides stable light and heat to the inner planets, including Symphony of Stars, with its habitable zone offering optimal conditions for Earth-type planets. The average orbital distance from its companion Eb16 is about 120 AU, and the gravitational interaction between the two stars stabilizes the orbits of small bodies within the system. Eastern Calendar-era astronomers considered the stability of Ea16 as the decisive basis for system colonization.",
  },
...

  {
    ...
    descriptionEn: "An academic city planet located within the E16 binary system, boasting the highest intellectual level in the system as a research hub. The entire planet is composed of academic institutions and research facilities, among which the Lorenz International University is renowned as a research center for dimensional pole theory and Apolonon physics. The planet Biblio also houses the highest-level archive of the A-Registry, where all historical documents and citizen data of the E16 civilization zone are backed up. During the Techno-Cultural Renaissance period, the theoretical foundation of the Persephone Project was constructed by researchers on this planet. It is constantly inhabited by tens of thousands of researchers and students and operates as a special autonomous region that upholds academic freedom and knowledge sharing as its highest ideals.",
  },
...

  {
    ...
    descriptionEn: "A nation in the Crescent region led by Supreme Marina Bobin, with strengths in military power and industrial base. Miertenga developed rapidly during the recovery period after the Slime Crisis, with biotechnology industries established to counter Reach Drain becoming the core of the national economy. Under Marina Bobin's strong leadership, the nation has built an efficient governance system and expanded its military influence in the Crescent region. As a founding member of the Trinity Alliance, it has formed military alliances with Vermilion and Bogdas Javelin, functioning as the center of forces opposing V7. Miertenga's military technology is a unique application of biological technology developed by the Matriscal society of Eros-7, with many undisclosed secrets not shared with other nations. The nation's name is said to derive from the ancient language of early settlers, though details remain unknown.",
  ...
  /* 西大陸都市 */
  {
    ...
    descriptionEn: "A trading city in the Gigapolis sphere. It functions as a logistics hub for the Symphony of Stars Western Continent, a vibrant port city that relays raw materials and products from various regions. After the Maastricht Revolution in El Forlhaus, it developed as a center for free trade.",
  },
...

  {
    ...
    descriptionEn: "A vast network infrastructure spanning the entire underground of Gigapolis, a multi-level underground structure functioning as the artery for energy supply, communications, and logistics. During the Slime Crisis, giant slime nests that thrive in the underground humid environment formed, causing severe damage to Gigapolis's infrastructure. Ayaka Rin led the suppression operation, contributing to the resolution of the crisis. Safety measures have since been significantly strengthened, and parts of it have been developed as tourist tunnels. It is also connected to the underground shopping district, becoming an important component of Gigapolis's underground world.",
  },
...

  {
    ...
    descriptionEn: "The most important military facility of ZAMLT, a massive complex with a complex structure of 10 floors above ground and 10 floors below. The energy core of Protocol X was stored here, and the core of ZAMLT's dimensional technology and military power was concentrated. The Silver Plant assault by Alpha Kane and the warriors of Texus was the decisive battle that became the turning point of the Gigapolis Liberation War. It was also the tragic stage where Linda, a researcher of the Lorentz Corporation, sacrificed herself to stabilize the runaway energy core of Protocol X. Linda's self-sacrifice greatly boosted the morale of the Shadow Rebellion and became a turning point that spread anti-establishment sentiment even within ZAMLT. After its collapse, part of it was dismantled, but most of the underground structure remains unexplored.",
  },
  ...
  /* 宇宙構造物 (5) */
  {
    ...
    descriptionEn: "The largest space station in the E16 star system, constructed in low orbit of the Symphony of Stars, a space city with over 100,000 personnel stationed at all times. Orbital Station Omega began construction in E200 by a corporate consortium during the Pax Lombardica period, reaching its current scale in E260. The station has residential, commercial, industrial, and research areas hierarchically arranged, functioning as a major hub for interplanetary navigation. During the E524 Interstellar Federal Summit, Omega's international conference hall was used, becoming a venue for diplomatic negotiations on a cosmic scale. Large-scale solar panels and dimensional energy generation devices are installed on the station's outer walls, supplying the entire station's electricity independently. It is under the management of the UECO Interstellar Economic Cooperative, which handles port entry/exit management and security.",
  },
