...
export const WIKI_ORGANIZATIONS = [{
    ...
    descriptionEn:
      "A historical empire that boasted overwhelming military power in the M104 Galaxy. During the Meldean War (E275-E288), it clashed with the Sextus Alliance and achieved victory through overwhelming firepower from dimensional weapons. While establishing post-war hegemony and bringing about the Fifth Prosperity Period, the use of dimensional weapons sparked galaxy-wide ethical debates. The military tradition of the empire was inherited by the Teclosas lineage, leaving a profound impact on the military history of the Western Continent. Although no official successor state to the empire exists today, its legacy is inherited by many factions.",
  },{
    ...
    descriptionEn:
      "An ancient bloodline group known as the 'witches' who wield a special mark called the Sigil Affect. Based in the Crescent region, they have passed down their unique magical system and combat techniques through generations, making their name known throughout the surrounding areas. They were an opposing force that Iris encountered while active in Crescent, and their attacks using Sigil Affect technology have the characteristic of nullifying conventional physical defenses. The origins of this clan are shrouded in mystery, with theories linking them to ancient dimensional technology.",
  },{
    id: "ファランクス" as WikiId,
    name: "ファランクス",
    nameEn: "Phalanx",
    ...
    leaders: [
      { id: "アレン", name: "アレン", nameEn: "Allen", role: "ストロベリーCEO", era: "E318年前後" },
    ],
  },{
    ...
    descriptionEn:
      "Following the collapse of the Barz Empire in E50, an interim governing body established by the leaders of surviving colonies. Centered on the planet Biblio and Solaris, it coordinated seven colonies, prioritizing the reconstruction of food production, defense, and communication infrastructure. The council operated on a deliberative system with democratic features, giving equal speaking rights to representatives from each colony. However, to address resource shortages and external threats, authority gradually concentrated in the hands of powerful colonies. The First Immigration Council was progressively dissolved into the formal Planetary Federation of Nations during the E80 Enlightenment Era, with its legacy indirectly inherited by UECO's current consultative system.",
  },{
