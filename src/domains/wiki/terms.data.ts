...
export const WIKI_TERMS = [
...

  {
    ...
    descriptionEn: "A theory of international politics that when emerging great powers rise, structural conflicts arise with existing great powers, making war inevitable. It is an application of the concept proposed by the ancient Greek historian Thucydides in his analysis of the Peloponnesian War to a cosmic scale. The Galactic Consortium lists avoiding this trap as its most important policy goal, and has pointed out dangers in the relationship between Granbel (economic rank 1) and Tierra (military rank 3). The relationship between Apollo and Selinopolis in the past is analyzed to have had a similar structure, and the lessons from that are reflected in current foreign policy. For details, refer to 'Hegemony Paradox' (Cosmic Civilization Sphere)."
  },
     ...
     ═══════════════════════════════════════════ */
  {
    ...
    descriptionEn: "The number one economic power in the cosmic rankings, accounting for approximately 25% of the entire universe's GDP with 150 trillion dollars. The capital is Alda City. It rose to prominence by observing the Apollo-Dominion War and capitalizing on the post-war chaos period. It overwhelms other civilizations through multiverse exploration and interdimensional technology. While the danger of the Hegemony Paradox with Tiera is pointed out, it cooperates with Elesion in technological fields. Current President Arzen Carline hosted the first United Cosmic Assembly. The first leader was Master Quincius, who highly valued the Celia era and positioned it as a successor civilization. Successive leaders have maintained the philosophy of inheriting Celia's legacy, forming the spiritual foundation of Granbel's economic prosperity.",
    era: "現在",
    sourceLinks: [
      {
...

  {
    ...
    descriptionEn: "The capital of Granbel. The birthplace of interdimensional communication technology and the center of the quantum economy. The most developed city in the universe. The Olda Prime Hall was designed using dimensional distortions and can accommodate tens of thousands of people. Venue for the first United Nations of Space meeting.",
    sourceLinks: [
      {
        url: "https://raw.githubusercontent.com/gentaron/edutext/main/eduuni.txt",
        label: "eduuni.txt",
...

  {
    ...
    descriptionEn: "The core planet of the Apollo civilization. All military forces were mobilized from here. In the final phase of the Apollo-Dominion war, it was captured and shattered by Seria's Venom fleet, becoming a symbol of the destruction of the Apollo civilization.",
    sourceLinks: [
      {
        url: "https://raw.githubusercontent.com/gentaron/edutext/main/eduuni.txt",
        label: "eduuni.txt",
...

  {
    ...
    descriptionEn: "Diverse food culture developed in the E16 civilization zone. Through crossbreeding of self-propagating plants from Symphony of Stars and crops brought from Earth, it evolved uniquely while based on Earth's cuisine. In the Crescent Great Region, freshwater fish dishes from Miertenga Lake, grain dishes from Blue Rose Plain, and canyon vegetables from Vermilion Valley are specialties. During the Techno-Cultural Renaissance, the circulation of alien ingredients through Horizon Gates began, and dishes such as Faruja's desert cuisine, Elesion's health food, and Granbel's fusion cuisine became available throughout the E16 star system. At the Acadia of Biblio, an interdisciplinary research field called 'Philosophy of Food' was established, seeking to promote inter-civilizational understanding through food culture. The South Market is known as a holy place for gourmet food where alien ingredients gather."
  },
