...
export const WIKI_CHARACTERS = [{
    ...
    descriptionEn:
      "Effectively ruling the deepest part of Gigapolis Underground since E400. During the Evatron Dominion period (E400-E475), he operated in the shadows as the true power of the underworld, separate from the surface ruler Evatron. Known by two names, Tina and Gue, leading to various theories about his true identity. By mastering the underground economy and utilizing a unique information network, he has maintained his influence even after Evatron's collapse.",
    era: "E400〜現在",
    ...
    descriptionEn:
      "Leader of the immigrant expedition and proponent of the 10-dimensional Horazm theory. Around E0, he designed the virtual multiverse 'Persephone' to survive the harsh cosmic environment, opening the path to uploading the consciousness of immigrants. His theory developed into the concept of the Dimensional Ladder Pandictum, laying the foundation for EDU cosmology. However, the Persephone experiment accident led to the unexpected manifestation of the Slime Woman in E340.",
    era: "E0頃",
    affiliation: "移民団",
    tier: "歴史的人物",
    ...
    descriptionEn:
      "Lv569. Appeared around AURALIS in E325. A deeply involved figure in AURALIS Collective's activities, resonating with the philosophy of 'making light and sound eternal.' He has watched over AURALIS's rise and fall from the Selia Golden Age (E335-E370), through Evatron's oppression (E400), to the second-generation revival (E522). His appearance is related to Leila Viller Nova's joining of AURALIS, and he may have witnessed her heroic actions during the Slime Crisis up close. It is believed he continues activities related to AURALIS after the official establishment of the second generation in E522.",
    era: "E325〜現在",
    ...
    descriptionEn:
      "Founder of the AURALIS Collective. Real name Lily Steiner, publicly known as 'Lillie Ardent, the First.' In E270, she met Kate Claudia and co-founded AURALIS. Revered as the 'Flame of Emotion,' her performances that transcended gender boundaries on stage became legendary. She watched over Leila's cryosleep closer than anyone, greeting her with 'Welcome back' each time she awoke. Arrested during the E400 Evatron suppression, she delivered her final words: 'AURALIS will never disappear. From the ashes, it will burn once more.' Her name was inherited by the Lillie Ardent of the new era.",
    era: "E270〜E400",
    affiliation: "AURALIS Collective第一世代（創設者）",
    tier: "神格・歴史的人物",
    ...
    descriptionEn:
      "Deputy leader of Bogdas Javelin. As Sebastian Valerius's right hand, bears overall combat command of the unit, leading troops from the front in the rescue operations of E510 and E519. As a soldier of the Technosus lineage, possesses refined leadership skills and is a reliable officer who commands absolute trust from his members.",
    era: "E490〜現在",
    affiliation: "ボグダス・ジャベリン",
    tier: "Tier 2",
    ...
    descriptionEn:
      "A former prisoner held captive by Silver Venom. During the Iris rescue operation in E510, was freed through coordination with Bogdus Javelin. After liberation, approached the Trinity Alliance out of gratitude and trust for Iris, and is said to have contributed to establishing relations with Vermilion.",
    era: "?〜E512",
    affiliation: "捕虜（のち救出）",
    tier: "Tier 2",
    ...
    descriptionEn:
      "Bogdus Javelin's reconnaissance and detection specialist. Proficient in stealth operations and information gathering, responsible for terrain analysis and identifying hazardous areas in enemy territory as Sebastian Valerius's advance scout. During the Iris rescue operation in E510, identified gaps in Silver Venom's defensive network and secured infiltration routes for the unit.",
    era: "E490〜現在",
    affiliation: "ボグダス・ジャベリン",
    ...
    descriptionEn:
      "Bogdus Javelin's close combat specialist. Known for a high-speed combat style wielding twin swords, single-handedly receiving enemy attacks at the forefront of the unit. One of the elite directly trained by Gares, his swordsmanship embodies the combat doctrine of the Teklosas lineage.",
    era: "E490〜現在",
    affiliation: "ボグダス・ジャベリン",
    ...
    descriptionEn:
      "Bogdus Javelin's rear support and medical specialist. Single-handedly handles the treatment of wounded personnel and the unit's logistics management, sustaining the unit's combat capability even in harsh battlefields. With a calm and composed personality, enjoys Gares's deep trust and is an indispensable presence as the unit's cornerstone.",
    era: "E490〜現在",
    affiliation: "ボグダス・ジャベリン",
    ...
    descriptionEn:
      "Bogdus Javelin's infiltration and assassination specialist. Acts without leaving traces as his name suggests, specializing in solo infiltration into enemy key strongholds. A mysterious special operative with many unknown aspects; even Sebastian is said not to grasp his full identity.",
    era: "E490〜現在",
    affiliation: "ボグダス・ジャベリン",
    ...
    descriptionEn:
      "A separate individual from Castina Tempest (leader of Crosevia). Based in Gigapolis' Western Continent. While not directly involved in the political situation of the Crescent Region, this individual offers a unique perspective on society in the Western Continent.",
    era: "不詳",
    affiliation: "Gigapolis西大陸",
    tier: "Tier 2",
    ...
    descriptionEn:
      "An individual active somewhere in the E16 star system. An existence that experiences the world from a perspective separate from the major events of the EDU universe.",
    era: "不詳",
    affiliation: "不詳",
    tier: "Tier 2",
    ...
    descriptionEn:
      "Centered on the personal stories of individuals in the E16 star system, it depicts lives and adventures on a different scale from heroes, yet equally part of the EDU world. Likely set in contemporary society after the Techno-Cultural Renaissance (E475-E500).",
    era: "不詳",
    affiliation: "不詳",
    tier: "Tier 2",
    ...
    descriptionEn:
      "The first Emperor of the Bartz Empire. In E15, he led the military faction Phalanx to forcefully end the initial colonial disputes among the E16 star system's colonies, establishing the Bartz Empire—the first comprehensive unified government in the star system. Though called an empire, Phalanx respected the tradition of early settler autonomy and introduced a system of regional governorates equivalent to various ministries. After his death in E61, the empire split due to succession disputes, but its military tradition was carried on through the Tectlos lineage, continuing to the present Bogdus Javelin.",
    era: "E15〜E61",
    affiliation: "バーズ帝国",
    tier: "歴史的人物",
  },{
